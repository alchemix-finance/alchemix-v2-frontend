  ...
  {:else}
    ...
    <div class="w-full mb-8">
      <ContainerWithHeader>
        <div slot="header" class="py-4 px-6 flex space-x-4">
          <Button
            label="Your Strategies ({countStrategiesForTypeOfStrategy(
          ...
          <Button
            label="All Strategies ({countStrategiesForTypeOfStrategy(
          ...
          <Button
            label="Unused Strategies ({countStrategiesForTypeOfStrategy(
