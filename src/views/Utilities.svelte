...
<ViewContainer>
  ...
  <ContainerWithHeader>
    ...
    >
      <p class="text-left">{$_('utilities_page.stats_widget_title')}</p>
      <Button
        label="{$_('utilities_page.stats_widget_button')}"
        borderSize="1"
        height="h-8"
    ...
    <div slot="body" class="overflow-x-auto lg:overflow-x-hidden h-96">
      <iframe class="w-full h-full" src="https://alchemix-stats.com"></iframe>
    </div>
  </ContainerWithHeader>
</ViewContainer>
